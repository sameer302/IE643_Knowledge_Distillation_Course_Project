...
if __name__ == "__main__":
    ...
    # ===============================================================
    # 🧩 DEBUG: Check for stray Linear modules
    # ===============================================================
    import gc, torch.nn as nn

    # print("\n🔍 Scanning for stray nn.Linear modules before profiling...")
    # count = 0
    # for obj in gc.get_objects():
    #     if isinstance(obj, nn.Linear):
    #         count += 1
    #         try:
    #             print(f"   → Found Linear: weight={tuple(obj.weight.shape)}, bias={tuple(obj.bias.shape)}")
    #         except Exception:
    #             pass
    # print(f"🔎 Total Linear modules found in process: {count}")
